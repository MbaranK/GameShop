...
namespace GameShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Parolanızın eşleşmesi gerekmektedir.")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                _roleManager.CreateAsync(new IdentityRole(Role.Role_Admin)).GetAwaiter().GetResult();// senkron hale getirdik.
